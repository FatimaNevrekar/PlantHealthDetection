...
class CustomDataset(utils.Dataset):
    ...
    def load_mask(self, image_id):
        ...
        for i, p in enumerate(info["polygons"]):
            ...
            # Clipping rr and cc to be within the bounds of the image
...
def train(model):
    ...
    dataset_train.load_custom("/Users/fatimanevrekar/Desktop/Plant_Health_Detection/Plant_Health_MaskRCNN/Dataset", "train")
    
    dataset_train.prepare()

    # Validation dataset
    dataset_val = CustomDataset()
    dataset_val.load_custom("/Users/fatimanevrekar/Desktop/Plant_Health_Detection/Plant_Health_MaskRCNN/Dataset", "val")
    dataset_val.prepare()
